...
(check-equal? (compile-code '(cond
              ...
              '("  ldy n"
                ...
                "  jmp _cond_done_0003"
                "_cond_lookup_val_0001_data:"
                ".byte res_res2__attr__bank"
                ".byte res_res3__attr__bank"
                ".byte res_res4__attr__bank"
                ".byte res_res5__attr__bank"
                "_cond_lookup_val_0001 = _cond_lookup_val_0001_data - 2"
                "_cond_lookup_low_val_0004_data:"
                ".byte res_res2__attr__low"
                ".byte res_res3__attr__low"
                ".byte res_res4__attr__low"
                ".byte res_res5__attr__low"
                "_cond_lookup_low_val_0004 = _cond_lookup_low_val_0004_data - 2"
                "_cond_lookup_hi_val_0005_data:"
                ".byte res_res2__attr__high"
                ".byte res_res3__attr__high"
                ".byte res_res4__attr__high"
                ".byte res_res5__attr__high"
